...
const Resume = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white mx-auto pt-12 lg:pt-36">
      {/* Resumes Display */}
      <div className="flex flex-col sm:flex-row justify-center items-center gap-8 w-full max-w-[1100px] px-4">
        {/* Resume 1 */}
        <div className="w-full sm:w-[45%]">
          <iframe
            ...
            style={{ minHeight: "400px" }} // Ensure a minimum height for mobile
          ></iframe>
        </div>
...
//   return (
//     <div className="min-h-screen flex flex-col items-center justify-center  bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white mx-auto pt-16 lg:pt-24">
//       {/* Resumes Display */}
